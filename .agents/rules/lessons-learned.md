...
- **Curriculum Drawer DOM Nesting & Scrolling Architecture (2026-08-31)**:
  ...
  3. *Flex Child Scroll Containment*: Pada tata letak flexbox vertikal modal/drawer, kontainer scroll internal (`.drawer-content`) wajib dilengkapi properti `flex: 1 1 auto; min-height: 0; overscroll-behavior: contain; -webkit-overflow-scrolling: touch;` serta penataan scrollbar kustom agar scrolling berjalan mulus di perangkat desktop maupun mobile.
