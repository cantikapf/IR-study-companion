...
The historical origins of the sovereign state system are conventionally benchmarked to developments in Europe, notably the Peace of Westphalia in 1648. While contemporary historiography (such as Osiander, 2001) emphasizes that Westphalia was an evolving milestone rather than an instantaneous creation of absolute sovereignty, it cemented the foundational norms of mutual recognition and territorial authority. The theoretical concept of <mark class="nice-mark" style="--color: hsl(158, 47%, 83%)">state sovereignty</mark> was articulated by thinkers like Jean Bodin and Thomas Hobbes, who emphasized the supreme authority of the sovereign within a defined territory. 
