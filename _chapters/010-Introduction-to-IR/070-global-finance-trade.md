...
{% include flashcards.html term1="Globalization" def1="Increasing global interdependence through cross-border transactions, capital flows, technology, and multinational corporations." term2="Bretton Woods Conference" def2="Post-WWII meeting creating a global economic order, fixed exchange rates, IMF, and World Bank." term3="Financial Liberalization" def3="Policies reducing regulation on financial markets, aiming to free capital flows but linked to instability." term4="World Trade Organization (WTO)" def4="Successor to GATT, it sets rules for global trade, mediates disputes, and facilitates agreements." %}

### Knowledge Check
{% include quiz.html id="quiz_070_global_finance_trade" question="According to the chapter, what was a key lesson highlighted by the 2007-2008 financial crisis concerning global finance?" opt1="The necessity of increasing the global flow of 'hot money' for economic growth." opt2="The compatibility of financial liberalization with strong control regimes for stability." opt3="The critical importance of robust regulation and oversight in liberalized financial markets." opt4="The diminishing role of the IMF and World Bank in ensuring financial stability." correct="3" %}
