...
### Knowledge Check
{% include quiz.html id="quiz_030_culture_social_science" question="What is the main difference between cultural relativism and ethnocentrism?" opt1="Cultural relativism asserts equal validity of cultures, while ethnocentrism judges others by ones own standards" opt2="Ethnocentrism promotes objective analysis, while cultural relativism imposes external standards" opt3="Both terms refer to the process by which cultures become more alike" opt4="Cultural relativism only applies to popular culture, while ethnocentrism applies to subcultures" correct="1" %}
