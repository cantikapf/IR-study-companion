...
{% include flashcards.html term1="International Criminal Law" def1="Focuses on individual accountability for international crimes" term2="War Crimes" def2="Violations of international humanitarian law in armed conflict" term3="Crimes Against Humanity" def3="Widespread or systematic attacks on civilian populations" term4="Complementarity" def4="ICC intervenes when national courts are unwilling or unable" %}

### Knowledge Check
{% include quiz.html id="quiz_090_ICL" question="What is the primary focus of international criminal law?" opt1="Holding states accountable for international crimes" opt2="Holding individuals accountable for international crimes" opt3="Promoting economic cooperation among nations" opt4="Resolving territorial disputes between states" correct="2" %}
