...
{% include flashcards.html term1="International Humanitarian Law" def1="Legal framework limiting armed conflict effects" term2="Military Necessity" def2="Measures necessary to defeat the enemy" term3="Distinction" def3="Principle to distinguish between combatants and civilians" term4="Proportionality" def4="Incidental loss of civilian life must not be excessive" %}

### Knowledge Check
{% include quiz.html id="quiz_094_IHL" question="What is the core purpose of International Humanitarian Law?" opt1="To protect the environment during war" opt2="To preserve human dignity and humanity in times of war" opt3="To promote economic interests during conflict" opt4="To expand territorial control" correct="2" %}
